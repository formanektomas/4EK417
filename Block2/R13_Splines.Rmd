...
General notation for natural cubic splines with $K$ knots ($k=1,2,\dots,K$):  
...
+ Hence, the tree quantiles $q_{0.25}$, $q_{0.50}$ and $q_{0.75}$ are treated as *inner knots* and linearity restrictions are imposed on conveniently chosen *boundary knots*.
...
# no intercept is default, so: df=4 --> 4-1 = 3 inner knots.
