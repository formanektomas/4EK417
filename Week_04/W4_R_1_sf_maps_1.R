...
df20.2003 <- sf::st_as_sf(eurostat::get_eurostat_geospatial(output_class = "spdf", year="2003",
                                                            resolution = 20))
df1 <- sf::st_as_sf(eurostat::get_eurostat_geospatial(output_class = "spdf", resolution = 01))
#
#
#
#
