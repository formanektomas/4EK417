...
### The sum of all phi_{jm}^2 = 1 , phi vectors are orthogonal:
...
### Fitted values from PCR (regression on PC1 only)
...
## "True" prediction efficiency of the PCR estimation


To assess PCR vs OLS prediction efficiency, we shall split "Hitters" data.frame  into a train sample (model estimation) and test sample (to calculate and compare Salary predictions)
