...
```{r}
# Read the data
food.df <- read.csv('_dataW02/FoodDemand.csv') 
str(food.df)
```
...
This simplification approach is based on the equivalency of `ADL(1,1)` and `ECM` models (revert to Week2 presentation for the course 4EK608/4EK416):
