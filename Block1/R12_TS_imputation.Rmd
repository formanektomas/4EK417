...
* MI is applied to all series with missing data,  
* All available series are used for MI (ID variables need to be listed separately)  
* `polytime = 2` coefficients apply to all CS units (will be relaxed later)  
* `p2s` controls calculation details displayed  
* Here, we only display results for `tariff`  
