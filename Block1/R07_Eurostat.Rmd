...
```{r}
Un.DF %>% 
  filter(age == "Y15-74", TIME_PERIOD >= 2010, sex == "T", isced11 == "TOTAL") %>% 
...
Un.2017 <- Un.DF %>% 
  filter(age == "Y15-74", TIME_PERIOD == 2017, sex == "T", isced11 == "TOTAL") %>% 
...
```{r}
Un.DF %>% 
  filter(age == "Y15-74", TIME_PERIOD >= 2010, sex == "T", isced11 == "TOTAL") %>% # filter variables
...
Un.Q <- Un.Q %>% 
  filter(age == "Y15-74", TIME_PERIOD >= 2010, sex == "T", citizen == "FOR") %>% # filter variables
