...
* [Cheat sheet: eurostat R package](https://github.com/rstudio/cheatsheets/raw/master/eurostat.pdf)
* [Tutorial (vignette) for the eurostat R package](http://ropengov.github.io/eurostat/articles/website/eurostat_tutorial.html)
...
* Transforming Eurostat data into TS using '{zoo}'  
...
head(Un.Q.zoo)
autoplot(Un.Q.zoo) # from the {ggplot2} package, works well with TS
