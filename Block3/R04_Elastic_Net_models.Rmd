...
```{r}
plot(ridge.mod, xvar="lambda", label=FALSE, sign.lambda=1)
```
...
```{r}
plot(lasso.mod, xvar="lambda", label=FALSE, sign.lambda=1)
```
...
```{r}
plot(EN.mod, xvar="lambda", label=FALSE, sign.lambda=1)
```
