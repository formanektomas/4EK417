...
head(dat)
tail(dat)
write.csv(dat, "_dataW01/mcu_gdp.csv", row.names = F) # Writes the data into Working directory
#
...
?ggsave
ggsave("_dataW01/plot1.jpg", plot1) # save graph to disk
ggsave("_dataW01/plot1.pdf", plot1)
#
#