...
mtcars <- mtcars # copies df from package to Global Environment
?mtcars
...
##    .. hint: in the data frame, use as.factor() on "am".
## 4) Make a scatterplot of "mpg" ~ "wt" (Miles/Gallon as a function of car Weight)
## 5) Add suitable name (title) & lm regression line to plot 4)
