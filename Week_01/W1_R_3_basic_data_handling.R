...
Auto <- read.csv("_dataW01/Auto.csv") 
str(Auto)
head(Auto)
#
#
...
write.csv(Subset1, file = "_dataW01/Subset1.csv", row.names = F)
#
Subset1.reload <- read.csv("_dataW01/Subset1.csv") # 
str(Subset1.reload) 
head(Subset1.reload)
rm(list=ls())
#
...
#
#
USA <- read.csv("_dataW01/USA_states.csv")
