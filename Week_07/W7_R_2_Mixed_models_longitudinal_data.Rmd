...
* repeated observations (e.g. weightings) are grouped 

* by individuals (children) -- for each children, we have multiple weightings.
...
* st. dev. of $u_j$ `(Intercept)` describes variability among individuals.
